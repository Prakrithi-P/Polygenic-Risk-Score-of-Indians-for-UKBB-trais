---
title: "COVID19_PRS_IGVC"
author: "Prakrithi"
date: "09/09/2021"
output: html_document
---
Read and process summary stats for different traits from the UKBB
...
Overlap and select SNPs,
```{r Overlap and select SNPs, include=FALSE}
...
Calculate PRS from summary stats
``` {r PRS, include=FALSE}
...
PRS distribution across population
Box Plots
...
Spatial map of PRS acrosss IGV populations
```{r Spatial map, include=FALSE}
#spatial plots
library(rgdal)
library(tmap)
library(maptools)
